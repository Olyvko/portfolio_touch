   ...
   <!-- Post Content -->
    <article>
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                   <h2 class="section-heading" style="margin-top: 10px;font-size: 26px;">COMPUTER SKILLS</h2>
					<ul>
					<li>C, C++, Java</li>
					<li>PHP, MySQL, HTML</li>
					<li>Javascript, JQuery, Ajax</li>
					</ul>
                   <h2 class="section-heading" style="margin-top: 10px;font-size: 26px;">SOFTWARE DEVELOPMENT ENVIRONMENT</h2>
					<ul>
					<li>MS Visual Studio</li>
					<li>Eclipse, Netbeans</li>
					<li>phpDesigher 8</li>
					</ul>
                   <h2 class="section-heading" style="margin-top: 10px;font-size: 26px;">LANGUAGES</h2>
					<ul>
					<li>Ukrainian - Native speaker</li>
					<li>English - Intermediate</li>
					<li>Russian - Upper Intermediate</li>
					</ul>
                   <h2 class="section-heading" style="margin-top: 10px;font-size: 26px;">PERSONAL QUALITIES</h2>
					<ul>
					<li>Creativity</li>
