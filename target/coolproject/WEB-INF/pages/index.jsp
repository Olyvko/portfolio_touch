...
<body>
    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index">Roman page</a>
            </div>
    ...
    <header class="intro-header" style="background-image: url('<c:url value="/resources/images/about-bg.jpg"/>')">
        <div class="container">
            <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <p>I think that I am a smart person with mathematic abilities and logical thinking. I'm hard working, accurate , observant(attentive,watchful), responsable and comunicable person So I think I can be a good teamwork player.</p>
                <img class="img-responsive" src="<c:url value="/resources/images/myfoto.jpg"/>" alt="">
                <p> I have done many computer projects so I have a good experiance and knowledge of different programming languages.</p>
             </div>
        </div>
    </div>
